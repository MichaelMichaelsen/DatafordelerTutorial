(function() {
    ...
    let url2 = `https://services.datafordeler.dk/Dkskaermkort/topo_skaermkort/1.0.0/wms?username=${username}&password=${password}`
    var toposkaermkortwmts = L.tileLayer.wms(url2, {
        transparent: 'FALSE',
        layers: 'topo_skaermkort',
        format: 'image/png',
        attribution: myAttributionText,
    ...
    var baseLayers = {
        ...
        "Skærmkort WMS": toposkaermkortwmts
    };
