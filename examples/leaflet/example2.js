(function() {
    ...
    //     continuousWorld: true,
    // });
    let url2 = `https://services.datafordeler.dk/DHMSkyggekort/dhm_terraen_skyggekort/1.0.0/Wmts?username=${username}&password=${password}`;
    var hillshade = L.tileLayer(url2, {
        transparent: 'TRUE',
